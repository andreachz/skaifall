...
// export const userAgent = 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Mobile Safari/537.36'

// A pool of user agents (desktop + mobile for variety)
const userAgents = [
...
module.exports = {userAgent, userAgents}